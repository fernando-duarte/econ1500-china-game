"""
Visualization management for the China Growth Game.

This module contains the VisualizationManager class, which manages
the creation of visualization data for team histories.
"""
