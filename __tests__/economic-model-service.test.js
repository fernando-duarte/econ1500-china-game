...
describe('EconomicModelService', () => {
  ...
  beforeEach(() => {
    ...
    service = new EconomicModelService('http://localhost:5000', true);
  ...
  describe('health', () => {
    ...
    it('should call the API in real mode', async () => {
      ...
      const realService = new EconomicModelService('http://localhost:5000', false);
  ...
  describe('getGameState', () => {
    ...
    it('should call the API in real mode', async () => {
      ...
      expect(axios.get).toHaveBeenCalledWith('http://localhost:5000/game/state');
  ...
  describe('submitDecision', () => {
    ...
    it('should call the API in real mode', async () => {
      ...
      expect(axios.post).toHaveBeenCalledWith('http://localhost:5000/teams/decisions', {
        team_id: 'team-1',
        savings_rate: 0.5,
        exchange_rate_policy: 'market'
      });
